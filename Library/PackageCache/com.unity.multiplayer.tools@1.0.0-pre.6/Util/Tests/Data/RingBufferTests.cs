...
namespace Unity.Multiplayer.Tools.Util.Tests
{
    internal class RingBufferTests
    {
        ...
        public void RingBufferCanPushAndRead()
        {
            ...
            Assert.AreEqual(ring[^0], 8);
            Assert.AreEqual(ring[^1], 5);
            Assert.AreEqual(ring[^2], 3);
            Assert.AreEqual(ring[^3], 2);
            Assert.AreEqual(ring[^4], 1);
        ...
        public void RingBufferAtCapacityCanPushAndRead()
        {
            ...
            AssertIndexOutOfRange(ring, 7);
            Assert.AreEqual(ring[^0], 89);
            Assert.AreEqual(ring[^1], 55);
            Assert.AreEqual(ring[^2], 34);
            Assert.AreEqual(ring[^3], 21);
            Assert.AreEqual(ring[^4], 13);
            Assert.AreEqual(ring[^5], 8);
            Assert.AreEqual(ring[^6], 5);
            AssertIndexOutOfRange(ring, ^7);
        }
