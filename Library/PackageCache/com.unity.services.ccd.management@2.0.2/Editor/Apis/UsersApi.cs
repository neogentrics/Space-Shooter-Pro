...
namespace Unity.Services.Ccd.Management.Apis.Users
{
    ...
    internal class UsersApiClient : BaseApiClient, IUsersApiClient
    {
        ...
        public async Task<Response<CcdUser>> GetUserInfoAsync(Unity.Services.Ccd.Management.Users.GetUserInfoRequest request,
            Configuration operationConfiguration = null)
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"200", typeof(CcdUser)   },{"400", typeof(Models.ValidationError)   },{"401", typeof(Models.AuthenticationError)   },{"403", typeof(Models.AuthorizationError)   },{"404", typeof(Models.NotFoundError)   },{"429", typeof(Models.TooManyRequestsError)   },{"500", typeof(Models.InternalServerError)   },{"503", typeof(Models.ServiceUnavailableError)   } };
