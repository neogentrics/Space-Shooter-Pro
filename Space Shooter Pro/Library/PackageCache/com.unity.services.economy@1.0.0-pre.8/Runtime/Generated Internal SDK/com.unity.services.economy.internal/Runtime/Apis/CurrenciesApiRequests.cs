...
namespace Unity.Services.Economy.Internal.Currencies
{
    ...
    internal class DecrementPlayerCurrencyBalanceRequest : CurrenciesApiBaseRequest
    {
        ...
        [Preserve]
        public DecrementPlayerCurrencyBalanceRequest(string projectId, string playerId, string currencyId, string bundleId = default(string), CurrencyModifyBalanceRequest currencyModifyBalanceRequest = default(CurrencyModifyBalanceRequest))
        {
    ...
    internal class GetPlayerCurrenciesRequest : CurrenciesApiBaseRequest
    {
        ...
        [Preserve]
        public GetPlayerCurrenciesRequest(string projectId, string playerId, string bundleId = default(string), string after = default(string), int limit = default(int))
        {
    ...
    internal class IncrementPlayerCurrencyBalanceRequest : CurrenciesApiBaseRequest
    {
        ...
        /// <param name="currencyModifyBalanceRequest">CurrencyModifyBalanceRequest param</param>
        [Preserve]
        public IncrementPlayerCurrencyBalanceRequest(string projectId, string playerId, string currencyId, string bundleId = default(string), CurrencyModifyBalanceRequest currencyModifyBalanceRequest = default(CurrencyModifyBalanceRequest))
        {
    ...
    internal class SetPlayerCurrencyBalanceRequest : CurrenciesApiBaseRequest
    {
        ...
        [Preserve]
        public SetPlayerCurrencyBalanceRequest(string projectId, string playerId, string currencyId, string bundleId = default(string), CurrencyBalanceRequest currencyBalanceRequest = default(CurrencyBalanceRequest))
        {
