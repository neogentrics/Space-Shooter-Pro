...
namespace Unity.Services.Economy.Internal.Purchases
{
    ...
    internal class MakeVirtualPurchaseRequest : PurchasesApiBaseRequest
    {
        ...
        [Preserve]
        public MakeVirtualPurchaseRequest(string projectId, string playerId, string bundleId = default(string), PlayerPurchaseVirtualRequest playerPurchaseVirtualRequest = default(PlayerPurchaseVirtualRequest))
        {
    ...
    internal class RedeemAppleAppStorePurchaseRequest : PurchasesApiBaseRequest
    {
        ...
        [Preserve]
        public RedeemAppleAppStorePurchaseRequest(string projectId, string playerId, string bundleId = default(string), PlayerPurchaseAppleappstoreRequest playerPurchaseAppleappstoreRequest = default(PlayerPurchaseAppleappstoreRequest))
        {
    ...
    internal class RedeemGooglePlayPurchaseRequest : PurchasesApiBaseRequest
    {
        ...
        [Preserve]
        public RedeemGooglePlayPurchaseRequest(string projectId, string playerId, string bundleId = default(string), PlayerPurchaseGoogleplaystoreRequest playerPurchaseGoogleplaystoreRequest = default(PlayerPurchaseGoogleplaystoreRequest))
        {
